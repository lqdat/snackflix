...
class ListMovieTvshow extends StatefulWidget {
  const ListMovieTvshow({super.key});

  @override
  _ListMovieTvshowState createState() => _ListMovieTvshowState();
}

class _ListMovieTvshowState extends State<ListMovieTvshow> {
  ...
  Future<List<SingleMovie>> getList(int page) async {
    setState(() {
     ...
     await MovieApi().getTvShowMovies(page).then((value)=>
    setState(() {
      listMovies = value;
      isLoading=false;
    })
