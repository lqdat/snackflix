...
class ListMovieNew extends StatefulWidget {
  const ListMovieNew({super.key});

  @override
  _ListMovieNewState createState() => _ListMovieNewState();
}

class _ListMovieNewState extends State<ListMovieNew> {
